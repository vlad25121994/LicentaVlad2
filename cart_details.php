<?php
	...
	if(isset($_SESSION['user'])){
			...
			foreach($stmt as $row){
				...
				$output .= "
					<tr>
						...
						<td>&#108;&#101;&#105; ".number_format($subtotal, 2)."</td>
					</tr>
				";
			}
			$output .= "
				<tr>
					...
					<td><b>&#108;&#101;&#105; ".number_format($total, 2)."</b></td>
				<tr>
			";
		...
		if(count($_SESSION['cart']) != 0){
			...
			foreach($_SESSION['cart'] as $row){
				...
				$output .= "
					<tr>
						...
						<td><img src='".$image."' width='30px' height='30px'></td>
						<td>".$product['name']."</td>
						<td>&#108;&#101;&#105; ".number_format($product['price'], 2)."</td>
						<td class='input-group'>
							<span class='input-group-btn'>
			...
			$output .= "
				<tr>
					<td colspan='6' align='center'>Cos de cumparaturi gol.</td>
				<tr>
			";
		}
