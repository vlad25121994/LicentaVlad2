<?php
	...
	if(isset($_POST['reset'])){
		...
		if($password != $repassword){
			...
			if($row['numrows'] > 0){
				...
				try{
					...
					$_SESSION['success'] = 'Parola a fost resetata cu succes.';
				...
				$_SESSION['error'] = 'Codul nu se potriveste contului.';
				header('location: '.$path);
			}
		...
		$_SESSION['error'] = 'Va rog, sa va introduceti parola prima oara.';
		header('location: '.$path);
	}
