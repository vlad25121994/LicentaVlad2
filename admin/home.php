  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tablou de bord</li>
      </ol>
    </section>
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <?php
                ...
                echo "<h3>&#108;&#101;&#105; ".number_format_short($total, 2)."</h3>";
              ?>
              <p>Vanzari Totale</p>
            </div>
            <div class="icon">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Raport Vanzari Lunar</h3>
