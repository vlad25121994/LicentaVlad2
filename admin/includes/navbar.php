<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-lg"><b>Componente</b>IT</span>
  </a>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              <p>
                ...
                <small>Membru din <?php echo date('M. Y', strtotime($admin['created_on'])); ?></small>
              </p>
            </li>
            <li class="user-footer">
              <div class="pull-left">
                <a href="#profile" data-toggle="modal" class="btn btn-default btn-flat" id="admin_profile">Actualizeaza</a>
              </div>
